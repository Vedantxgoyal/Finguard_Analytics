...
// Verified live against the actual loaded dataset (see findings_report.md):
// these three accounts have confirmed fraud transactions in mv_account_velocity,
// so the example buttons demonstrate real fraud-flagged activity rather than
// risking a 404 from an account excluded by stratified sampling.
const EXAMPLE_ACCOUNTS = ["C7162498", "C351297720", "C416779475"];
